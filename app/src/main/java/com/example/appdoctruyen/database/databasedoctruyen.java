...
public class databasedoctruyen extends SQLiteOpenHelper {
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'kien','kien','kien@gmail.com',1)";

    private String SQLQuery9 = "INSERT INTO truyen VALUES (null,'Rùa và Thỏ','Phần 1:\n" +
            "\n" +
    ...
    private String SQLQuery10 = "INSERT INTO truyen VALUES (null,'Củ cải trắng','Mùa đông đã đến rồi trời lạnh buốt, Thỏ con không có gì để ăn cả. Thỏ con mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Thỏ con reo lên:\n" +
            "\n" +
    ...
    private String SQLQuery11 = "INSERT INTO truyen VALUES (null,'Dê đen và dê trắng','Dê đen và Dê trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            "\n" +
    ...
    private String SQLQuery12 = "INSERT INTO truyen VALUES (null,'Chú bé chăn cừu','Một chú bé chăn cừu cho chủ thả cừu gần một khu rừng rậm cách làng không xa lắm. Chăn cừu được ít lâu, chú cảm thấy công việc chăn cừu thực là nhàm chán. Tất cả mọi việc chú có thể làm để giải khuây là nói chuyện với con chó hoặc thổi chiếc sáo chăn cừu của mình.\n" +
            "\n" +
    ...
    public void onCreate(SQLiteDatabase db) {
        // thực hiện câu lệnh truy vấn không trả về kết quả
        db.execSQL(SQLQuery);
    ...
    //tạo cơ sở dữ liệu thành công gồm 2 bảng tài khoản và truyện
    ...
    public void AddTaikhoan(Taikhoan taikhoan){
        ...
        // thực hiện insert thông qua contenvalue
        ...
        values.put(PHAN_QUYEN, taikhoan.getmQuyen());
